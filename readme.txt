...
Spread it to the world! Leave a [review](http://wordpress.org/support/view/plugin-reviews/social-semantic-recommendation-sosere/) or simple say: "Thank you, good job."
...
**Common Questions about SOSERE Basic**
...
Please submit incompatible plugins and bugs by starting a new thread on [the WordPress.org forums](http://wordpress.org/support/plugin/sosere-recommendation/)

= Can I clear my cache? =

Once you activate caching by check "use cache" at the SOSERE options page you can uncheck it for 24 hours or wait this time period. 
...
Yes. You can choose between a list, thumbnails and thumbnails with post title. Also you can use custom css definitions.

= Why is there a "Hide recommendations" option? =

SOSERE use also user behaviour data for recommendations. It takes up to 8 weeks to collect enough for an usable network. 
You can activate the plugin but hide output to let it collecting data and start with a high quality of recommendations. 
